								...
								<div className="instructor-bx">
									...
									<div className="instructor-info">
										...
										<ul className="list-inline m-tb10">
											<li><a href="#" className="btn sharp-sm facebook"><i className="fa fa-facebook"></i></a></li>
											<li><a href="#" className="btn sharp-sm twitter"><i className="fa fa-twitter"></i></a></li>
											<li><a href="#" className="btn sharp-sm linkedin"><i className="fa fa-linkedin"></i></a></li>
											<li><a href="#" className="btn sharp-sm google-plus"><i className="fa fa-google-plus"></i></a></li>
										</ul>
