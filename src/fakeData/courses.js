export const courses = [
  ...
  },
  {
    ...
    description: {
      ...
      description:
        "You will know how to showcase your strengths and accomplishments in every job interview. You will learn secrets in preparation and planning that go beyond just checking out a company's website.",
    },
    price: {
      original: 1000,
      discount: 150,
  ...
  },
  {
    ...
    course_type: "general",
    description: {
      short_description: "Start Building Your Communication Skills Now",
      description:
        "Communication skills are essential in business and in life. Imagine yourself feeling comfortable and confident anytime you have to communicate with colleagues, bosses, customers, prospects, or clients",
    },
    price: {
      original: 999,
      discount: 150,
  ...
  },
  {
    ...
    description: {
      short_description:
        "Master C programming concepts from the ground up,Use the source code examples to learn step-by-step",
      description:
  ...
  },
  {
    ...
    description: {
      ...
      description:
        "The course consists of JAVA features, Java SEConcept of programming are made simple and easy.Every topic is explained with real-life examples.",
    },
    price: {
      original: 1500,
      discount: 150,
  ...
  },
  {
    ...
    description: {
      ...
      description:
        "Are you serious about starting a career in IT, acing tech interviews, and landing your dream job? This course was made for people who answered yes to these questions.",
    },
    price: {
      original: 1500,
      discount: 300,
